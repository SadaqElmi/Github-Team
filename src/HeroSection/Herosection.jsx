  ...
  return (
    ...
    >
      ...
      <div className="relative z-10  h-full  text-white p-8 ml-20">
        <h1 className="text-6xl font-bold mt-6 w-full max-w-lg leading-tight">Logistics You  Can Count On,  Start to Finish.</h1>
        <p className="text-sm mt-6 w-full max-w-lg leading-tight">
          We specialise in heavy haulage, freight solutions, and earthmoving transport. With a commitment
          to delivering excellence, we ensure your goods reach their destination safely, efficiently, and on time.
        </p>
